  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="relative w-full max-w-[584px] aspect-square mx-auto rounded-2xl overflow-hidden">
            <Image
...
//           <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
//             <button className="px-8 py-4 bg-primary text-primary-foreground rounded-lg hover:bg-accent transition-colors duration-300 font-semibold flex items-center gap-2 group">
//               Explore Services
//               <ArrowRight
//                 size={20}
//                 className="group-hover:translate-x-1 transition-transform"
